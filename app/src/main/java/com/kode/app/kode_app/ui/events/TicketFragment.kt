...
class TicketFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvTicketUser.text = SessionManager().getName()
        binding.tvTicketEvent.text = eventTitle
        binding.tvTicketCode.text = qrCode
        binding.ivTicketQR.setImageBitmap(generateQRCode(qrCode))
    }
    ...
    companion object {
        ...
        fun newInstance(eventId: Long, eventTitle: String, qrCode: String): TicketFragment {
